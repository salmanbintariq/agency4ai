  ...
  return (
    ...
    >
        ...
        >
          ...
          <div className="flex gap-2 text-sm">
            <input
              ...
              className="border border-gray-300 dark:border-gray-500 w-full p-3 text-sm rounded outline-hidden"
            />
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        className="flex sm:justify-between justify-center gap-4 flex-wrap pb-6 text-sm text-gray-500"
      >
